...
void GSM_Update()
{
    ...
    case GS_RESTART: // For restart
        /* NOTE: The main loop (main.cpp) handles GS_RESTART by
                 restoring previous/current and re-running Load/Init
                 of the prior state; no function pointers are modified
                 here by design. -ths */
        break;
