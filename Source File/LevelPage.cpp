...
void LevelPage_Draw()
{
    ...
    {
        if (i == 0) AEGfxSetColorToAdd(0.0f, 0.7f, 0.0f, 1.0f); // Green = Easy
        if (i == 1) AEGfxSetColorToAdd(0.0f, 0.0f, 0.7f, 1.0f); // Blue  = Normal
        if (i == 2) AEGfxSetColorToAdd(0.7f, 0.0f, 0.0f, 1.0f); // Red   = Hard
